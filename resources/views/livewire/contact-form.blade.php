<div class="col-lg-6 col-md-7 order-2 order-md-1">
    ...
    <div id="message_sent"
        ...
        <div>
            <span class="font-medium">Message Sent Successfully!</span> Thank you for contacting me. I'll get back to
    ...
    <div id="message_fail"
         class="d-none flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
         role="alert">
        <svg class="flex-shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
             fill="currentColor" viewBox="0 0 20 20">
            <path
        ...
        <span class="sr-only">Info</span>
        <div>
            <span class="font-medium">Error!</span> Oops! Something went wrong, please try again.
        </div>
        <button type="button"
                ...
                data-dismiss-target="#message_fail" aria-label="Close">
            <span class="sr-only">Close</span>
            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
